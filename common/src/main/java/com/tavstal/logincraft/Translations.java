...
public class Translations {
    ...
    static {
        ...
        JoinInvalidChar = builder.define("join_invalid_char", "Your name contains invalid char(s), please follow the '{0}' format.", 0, 256);
        JoinCountryBanned = builder.define("join_country_banned", "Your country is banned.", 0, 256);
        JoinFullServer = builder.define("join_full_server", "The server is full.", 0, 256);
        JoinSameName = builder.define("join_same_name", "Someone with the same name is playing on the server already.", 0, 256);
        builder.pop();
